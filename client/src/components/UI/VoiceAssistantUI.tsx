...
export default function VoiceAssistantUI() {
    ...
    return (
        <div className="max-w-md mx-auto my-auto h-full flex flex-col justify-center items-center p-6 rounded-2xl shadow-xl text-center">
            ...
            <div className="rounded-xl p-8 flex flex-col items-center justify-center min-h-[160px] mb-6">
